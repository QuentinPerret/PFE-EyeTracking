...
expName = 'PFE'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Quentin\\Desktop\\PFE\\PFE.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # define target for calibration_1
    calibration_1Target = visual.TargetStim(win, 
        name='calibration_1Target',
    ...
    # define parameters for calibration_1
    calibration_1 = hardware.eyetracker.EyetrackerCalibration(win, 
        eyetracker, calibration_1Target,
    ...
    # run calibration
    calibration_1.run()
    # clear any keypresses from during calibration_1 so they don't interfere with the experiment
    defaultKeyboard.clearEvents()
    # the Routine "calibration_1" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
